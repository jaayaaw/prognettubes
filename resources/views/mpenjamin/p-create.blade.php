...
<div class="nk-fmg-quick-list nk-block">
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ url('penjamin') }}" id="form1">
            @csrf
            <div class="mb-3 row">
                <label for="kode" class="col-sm-2 col-form-label">Kode</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="kode" name="kode" value="{{ $findmaxpenjamin }}" readonly="readonly">
                    </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label">Prefix Antrean</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control @error('prefix_antrean') is-invalid @enderror" id="prefix_antrean" name="prefix_antrean" >
