...
<div class="nk-fmg-body-head d-none d-lg-flex">
    ...
    <div class="nk-fmg-actions">
        <div class="btn-group">
            ...
            <a href="{{ route('gkomponen.list') }}" class="btn btn-sm btn-primary" onclick="buttondisable(this)"><em class="icon fas fa-arrow-left"></em> <span>Kembali</span></a>
        </div>
    </div>
...
<div class="nk-fmg-quick-list nk-block">
    <div class="card">
        <div class="card-body">
        <form method="POST" action="{{ url('gkomponen') }}/{{ $data['id'] }}" id="form1">
            @csrf
            @method('PUT')
            <div class="mb-3 row">
                <label for="group" class="col-sm-2 col-form-label">GROUP</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('group') is-invalid @enderror" id="group" name="group" value="{{ $data['group'] }}">
                        @error('group')
