...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color: blue;">Provider IKS</li>
  </ol>
</nav>
<br>
<div class="nk-fmg-body-head d-none d-lg-flex">
    ...
    <div class="nk-fmg-actions">
        <div class="btn-group">
            <a href="/masteriks" class="btn btn-sm btn-secondary" onclick="buttondisable(this)"><em class="icon fas fa-arrow-left"></em> <span>Kembali</span></a>&nbsp;
            <a href="{{ route('provideriks.create', ['id' => $id, $nama]) }}" class="btn btn-sm btn-primary" onclick="buttondisable(this)"><em class="icon fas fa-plus"></em> <span>Add Data</span></a>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    table = $('#{{$table_id}}').DataTable({
        ...
        ajax: {
            url: '{{ route("provideriks.listData") }}',
            type:"POST",
        ...
        columns: [
            ...
            },
            {
                ...
                {
                    return `<a href="{{ url('/') }}/dokumen/${data}" target="_blank" class="btn btn-outline-success">Download</a>`
                }
            },
            {
                data: 'aksi',
