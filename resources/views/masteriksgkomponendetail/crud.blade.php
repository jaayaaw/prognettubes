...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="gkomponen" style="color: grey;">Master IKS Group Komponen</a></li>
    <li class="breadcrumb-item active" aria-current="page" style="color: blue;">Master IKS Group Komponen Detail</li>
  </ol>
</nav>
<br>
<div class="nk-fmg-body-head d-none d-lg-flex">
    ...
    <div class="nk-fmg-actions">
        <div class="btn-group">
        <a href="/gkomponen" class="btn btn-sm btn-secondary" onclick="buttondisable(this)"><em class="icon fas fa-arrow-left"></em> <span>Kembali</span></a>&nbsp;
            <a href="{{ route('iksgkdetail.create', ['id' => $id]) }}" class="btn btn-sm btn-primary" onclick="buttondisable(this)"><em class="icon fas fa-plus"></em> <span>Add Data</span></a>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table id="{{$table_id}}" class="small-table table " style="width:100%">
                        <thead style="color:#526484; font-size:11px;" class="thead-light">
                            ...
                            <th width="10%">Group Komponen Detail</th>
                            <th width="10%">Aksi</th>
                        </thead>
                        <tbody></tbody>
                    </table>
...
$(document).ready(function() {
    table = $('#{{$table_id}}').DataTable({
        ...
        ajax: {
            url: '{{ route("iksgkdetail.listData") }}',
            type:"POST",
...
function deleteData(id,gkomponen_detail,elm){
    ...
    CustomSwal.fire({
        icon:'question',
        text: 'Hapus Data '+gkomponen_detail+' ?',
